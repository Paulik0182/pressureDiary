...
class BpRepoImpl: BpRepo {
    ...
    init {
        ...
        data.add(BpEntity(3, Calendar.getInstance().timeInMillis + 200000000,120, 95, 75, 3, "Хорошо"))
        data.add(BpEntity(4, Calendar.getInstance().timeInMillis + 30,125, 85, 60, 4, "Отлично"))
        data.add(BpEntity(5, Calendar.getInstance().timeInMillis + 400000000,130, 90, 80, 2, "Нормально"))
        ...
        data.add(BpEntity(8, Calendar.getInstance().timeInMillis + 700000000,140, 75, 55, 2, "Нормально"))
