...
class DiaryRepoImpl: DiaryRepo {
    ...
    init {
        data.add(DiaryEntity(1, LocalDate.now(), LocalTime.now(), 130, 90, 65, 2, "Нормально"))
        data.add(DiaryEntity(1, LocalDate.now(), LocalTime.now(), 140, 75, 55, 2, "Нормально"))
        data.add(DiaryEntity(1, LocalDate.now(), LocalTime.now(), 150, 80, 70, 1, "Плохо"))
        data.add(DiaryEntity(1, LocalDate.now(), LocalTime.now(), 120, 95, 75, 3, "Хорошо"))
        data.add(DiaryEntity(1, LocalDate.now(), LocalTime.now(), 125, 85, 60, 4, "Отлично"))
        data.add(DiaryEntity(1, LocalDate.now(), LocalTime.now(), 130, 90, 80, 2, "Нормально"))
        data.add(DiaryEntity(1, LocalDate.now(), LocalTime.now(), 145, 60, 70, 1, "Плохо"))
        data.add(DiaryEntity(1, LocalDate.now(), LocalTime.now(), 155, 100, 80, 0, "Очень плохо"))
    }
